...
#### `POST /api-game-player/heartbeat` - Обновить статус активности
```json
{
  "userId": 1,
  "timestamp": "2023-10-01T12:00:00Z" // опционально
}
```
...
### Требования
- Игроки должны отправлять heartbeat каждые 30 секунд
- Игроки считаются офлайн через 2 минуты без heartbeat
